...
INSERT INTO exercisetype_table (et_name,et_ename,et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("스탠딩사이드크런치","standing_side_crunch",5,3,2,'standing_side_crunch1','standing_side_crunch2','standing_side_crunch3',
'1. 정면을 보고 서서 양손을 귀옆으로 가져옵니다.
 2. 무릎을 한쪽을 올려 팔꿈치에 붙입니다.
 3. 반대 발도 2번과 동일하게 진행합니다.', 1);

INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("스탠딩니업","standing_knee_up",5,3,2,'standing_knee_up1','standing_knee_up2','standing_knee_up3',
'1. 정면을 보고  자세를 편안하게 합니다. 
2. 다리가 직각이 될때까지 올립니다.
3. 반대 편도 동일하게 진행합니다.', 1);

INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("라잉레그레이즈","lying_leg_raise",5,3,2,'lying_leg_raise1','lying_leg_raise2','lying_leg_raise3',
...
INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("크런치","crunch",5,3,2,'crunch1','crunch2','crunch3',
...
INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("바이서클크런치","bicycle_crunch",5,3,2,'bicycle_crunch1','bicycle_crunch2','bicycle_crunch3',
...
INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("시저크로스","caesar_cross",3,3,1,'caesar_cross1','caesar_cross2','caesar_cross3',
'1. 등을 바닥에 대고 눕습니다.
2. 상체를 살짝 들어올립니다.
3. 양발을  들어 좌우로 교차시킵니다. 
4. 해당 동작을 반복합니다.', 1);
...
INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("힘쓰러스크","himsseu_rusk",3,3,1,'himsseu_rusk1','himsseu_rusk2','himsseu_rusk3',
'1. 등을 바닥에 대고 눕습니다.
...
INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("플랭크","frank",4,3,2,'frank1','frank2','frank3',
...
INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("푸쉬업","push_up",5,3,2,'push_up1','push_up2','push_up3',
'1. 엎드린 자세에서 팔을  어깨넓이 로 벌립니다.
2. 팔꿈치를 굽혔다 폈다가를 반복합니다.', 1);


INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("니푸쉬업","nipples_up",3,3,1,'nipples_up1','nipples_up2','nipples_up3',
...
INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("Y-exercise","y_exercise",3,3,1,'y_exercise1','y_exercise2','y_exercise3',
'1. 배를 바닥에 두고 눕습니다.
...
#바벨운동
INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("바벨로우","barbell_row",5,5,2,'barbell_row1','barbell_row2','barbell_row3',
'1. 바벨을 들고 있는 상태에서 배에 힘을 주고 엉덩이는 뒤로 빼 몸의 각도가 45도가 되도록 합니다.
2. 숨을 뱉으면서 바벨을 당겨주고 숨을 내쉬면서 바벨을 내려줍니다.
3. 해당도작을 반복합니다.', 2);

INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("바벨데드리프트","barbell_deadlift",6,5,3,'barbell_deadlift1','barbell_deadlift2','barbell_deadlift3',
...
INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("덤벨벤트오버로우","bumbbell_bent_over_rows",6,5,3,'bumbbell_bent_over_rows1','bumbbell_bent_over_rows2','bumbbell_bent_over_rows3',
...
INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("바벨스쿼트","barbell_squat",6,5,3,'barbell_squat1','barbell_squat2','barbell_squat3',
...
INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("바벨런지","barbell_lunge",6,5,3,'barbell_lunge1','barbell_lunge2','barbell_lunge3',
'1. 양손으로 바벨을 잡아 어깨 뒤쪽 승모근에 걸치고 허리를 펴고 섭니다.
2. 한쪽 다리를 앞으로 내민 후 구부립니다
3. 뒤로 다시 물러서서 반대쪽 다리도 내밀어 실시합니다.', 2);

INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("오버헤드프레스","overhead_press",5,5,2,'overhead_press1','overhead_press2','overhead_press3',
...
INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("사이드레터럴레이즈","side_lateral_raise",5,5,2,'side_lateral_raise1','side_lateral_raise2','side_lateral_raise3',
...
INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("바벨컬","barbell_curl",5,5,2,'barbell_curl1','barbell_curl2','barbell_curl3',
'1. 다리를 어깨넓이 11자로 위치시키고 허리를 곧게 펴고 서서 언더그립으로 바벨을 잡아줍니다.
2. 호흡을 내쉬면서 팔꿈치를 구부려주세요.
3. 호흡을 들이 마시면서 시작자세로 돌아가주세요.', 2);

INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("덤벨컬","dumbbell_curl",4,5,2,'dumbbell_curl1','dumbbell_curl2','dumbbell_curl3',
'1. 어깨는 내리고 팔꿈치는 몸통에 밀착하듯이 붙인 후 덤벨을 듭니다. 
2. 이두근을 올린다는 생각으로 천천히 덤벨을 올려줍니다
3. 해당동작을 반복합니다.', 2);

INSERT INTO exercisetype_table (et_name, et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("딥스","dips",6,5,3,'dips1','dips2','dips3',
...
INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("풀업","pull_up",5,5,2,'pull_up1','pull_up2','pull_up3',
'1. 철봉을 어깨 넓이 만큼 잡습니다.
2. 가슴을 들어줍니다.
...
INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("행잉레그레이즈","hanging_leg_raises",6,5,3,'hanging_leg_raises1','hanging_leg_raises2','hanging_leg_raises3',
'1. 철봉을 어깨 넓이 만큰 잡습니다.
...
INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("렛폴다운","let_fall_down",6,5,3,'let_fall_down1','let_fall_down2','let_fall_down3',
...
INSERT INTO exercisetype_table (et_name,et_ename, et_met,et_time,et_lv,et_img1,et_img2,et_img3,et_description, ec_num) 
VALUE("페이스 풀","face_pull",6,5,3,'face_pull1','face_pull2','face_pull3',
